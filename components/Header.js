    ...
    return (
        <>
            <nav className="z-10 font-league-spartan flex justify-between items-center w-[100%] sticky top-0 px-[6%] py-4 mt-6 text-primary-color bg-[#0F172A] bg-opacity-[0.95]">
                <Link  href="/"><a className="text-action-color z-20 text-4xl text-left font-quicksand font-bold">J.</a></Link>
                ...
                <div className="hidden md:block fixed md:left-[6.5%] lg:left-[6%] bottom-0 after:block after:mx-auto after:w-[1px] after:h-[90px] after:bg-secondary-color">
                    ...
                    <a href="https://www.linkedin.com/in/irfanulislamjishan/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.facebook.com/rko.jishan/" target="_blank" rel="noopener noreferrer">
                        <svg className="mb-5 social-animation feather feather-facebook" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--secondary-color)" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                    </a>
                    <a href="https://codepen.io/jishan101/" target="_blank" rel="noopener noreferrer">
