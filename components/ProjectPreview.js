                ...
                <div className="card relative z-0 w-full lg:w-[70%] min-h-fit my-7 sm:my-10 rounded-lg bg-back-color shadow-card overflow-hidden">
                    <div className="m-[6%] z-10 relative">
                        ...
                        <div className="card-content lg:opacity-0 mt-5">
                            ...
                            <a className="inline-block" href="/" target="_blank" rel="noopener noreferrer">
                                <svg className="social-animation feather feather-external-link" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--secondary-color)" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
                            </a>
                        </div>
                    </div>
